...
public class Question implements Serializable {
	...
	private Vector<Aukera> aukerak = new Vector<Aukera>();
	...
	public Question(Integer queryNumber, String query) {
		super();
		this.questionNumber = queryNumber;
		this.question = query;
	}
	...
	public void newAukera(Aukera a) {
		aukerak.add(a);
	}
	
	public Vector<Aukera> getAukerak(){
		return this.aukerak;
	}

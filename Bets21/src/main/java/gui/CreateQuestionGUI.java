...
public class CreateQuestionGUI extends JFrame {
	...
	private final JButton btnNewButton = new JButton(ResourceBundle.getBundle("Etiquetas").getString("CreateQuestionGUI.btnNewButton.text")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		jComboBoxEvents.setEditable(false);
		...
		jButtonCreate.setBounds(new Rectangle(100, 270, 165, 30));
		...
		jButtonClose.setBounds(new Rectangle(318, 270, 162, 30));
		...
		datesWithEventsCurrentMonth=negozioLogika.getEventsMonth(jCalendar.getDate());
		paintDaysWithEvents(jCalendar,datesWithEventsCurrentMonth);
		
		

		jLabelEventDate.setBounds(new Rectangle(40, 15, 140, 25));
		jLabelEventDate.setBounds(90, 16, 140, 25);
		getContentPane().add(jLabelEventDate);
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFrame e11 = new AdminGUI();
				nirePantaila.setVisible(false);
				e11.setVisible(true);
			}
		});
		btnNewButton.setFont(new Font("Tahoma", Font.PLAIN, 16));
		btnNewButton.setBounds(10, 10, 60, 21);
		...
		panel_1.setBounds(56, 295, 481, 38);
		...
		euskeraRdioButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				nirePantaila.setTitle(ResourceBundle.getBundle("Etiquetas").getString("CreateQuery"));
		...
		try {
			...
			if (inputQuery.length() > 0) {
				...
				if (inputPrice <= 0)
					...
					negozioLogika.createQuestion(event, inputQuery, inputPrice);
